...
struct ClassCreator: ElementCreator {
    func createAllElements(for type: UMLElementType, middle: CGPoint) -> [UMLElement] {
        ...
        element.children?.append(elementAttribute)
        element.children?.append(elementMethod)
...
struct EnumerationCreator: ElementCreator {
    func createAllElements(for type: UMLElementType, middle: CGPoint) -> [UMLElement] {
        ...
        element.children?.append(elementAttribute1)
        element.children?.append(elementAttribute2)
        element.children?.append(elementAttribute3)
